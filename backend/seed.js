...
const articles = [
    ...
    {
        title: 'Resume vs. Resume',
        body: 'Learn how to write a winning resume (or resume).',
        tags: ['resume', 'career']
    },
    {
    ...
    },
    {
        ...
        body: 'How to write a resume that lands interviews.',
    ...
    {
        title: 'Prashant Builds Search Engines',
        body: 'Prashant builds semantic search engines and loves croissants.',
        tags: ['prashant', 'search', 'croissant']
    },
];
